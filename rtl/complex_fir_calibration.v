...
module complex_fir_calibration #(
    ...
    // Generated FIR IP interfaces are fixed at 16/18/Q2.16/45; retain plan-mandated parameters only as guarded API fields.
`ifndef SYNTHESIS
    initial begin : validate_fixed_ip_parameters
        if ((DATA_WIDTH != 16) || (COEF_WIDTH != 18) ||
            (COEF_FRAC != 16) || (NTAPS != 45)) begin
            $fatal(1, "complex_fir_calibration generated IP requires DATA_WIDTH=16, COEF_WIDTH=18, COEF_FRAC=16, NTAPS=45");
        end
    end
`endif
